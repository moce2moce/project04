...
interface Props {
  course_detail: CourseDetailInterface;
}

const CourseDetailPage: React.FC<Props> = ({ course_detail }) => {
  return (
      ...
      <div className="container">
        <div className="row">
          <div className="col-12 mb-4">
            {/* <!-- course thumb --> */}
            <img src={course_detail.image} className="img-fluid w-100" />
          </div>
        </div>
        {/* <!-- course info --> */}
        <div className="row align-items-center mb-5">
          <div className="col-xl-3 order-1 col-sm-6 mb-4 mb-xl-0">
            <h2>{course_detail.category}</h2>
          </div>
              ...
              <li className="list-inline-item mr-5 mb-3 mb-sm-0">
                <div className="d-flex align-items-center">
                  ...
                  <div className="text-left">
                    ...
                    <p className="mb-0">{course_detail.duration}</p>
                  </div>
                </div>
              </li>
              <li className="list-inline-item mr-5 mb-3 mb-sm-0">
                <div className="d-flex align-items-center">
                  ...
                  <div className="text-left">
                    ...
                    <p className="mb-0">From: {course_detail.fee}</p>
                  </div>
                </div>
              </li>
            </ul>
